...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="frecciasu" action="uploadSesso">Fix and upload</g:link></li>
    </ul>
</div>
        ...
        <g:else>
            <tr>
                ...
                <g:sortableColumn property="sesso"
                                  title="${message(code: 'bioWiki.revid.label', default: 'Sesso')}"/>
        ...
        <g:else>
            <g:each in="${bioWikiInstanceList}" status="i" var="bioWikiInstance">
                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                    ...
                    <td><g:link action="show"
                                id="${bioWikiInstance.id}">${fieldValue(bean: bioWikiInstance, field: "sesso")}</g:link></td>
