...
<head>
    ...
    <title><g:message code="bio.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
<a href="#edit-bio" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="edit-bio" class="content scaffold-edit" role="main">
    <h1><g:message code="bio.edit.label" args="[entityName]" default="Aggiungi"/></h1>
