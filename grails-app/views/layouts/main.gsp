...
<div id="algosLogo" role="banner">
    <a href="http://www.algos.it/">
        <img src="${resource(dir: 'images', file: 'logo_chiaro.png')}" height="60" alt="Algos"/></a><a
        href="http://www.algos.it/"><img src="${resource(dir: 'images', file: '')}" height="60"
                                         alt="${grailsApplication.metadata.'app.name'}"/></a></div>
		<g:layoutBody/>
